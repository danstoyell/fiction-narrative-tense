#!/usr/bin/env python3
"""Stage or promote quote-bearing books from the 1996--2015 round-seven fetch."""
...
SOURCE_SAMPLE = batch.DATA / "sample_topn5_1996_2015_to10_round7.csv"
SELECTION = batch.DATA / "sample_topn5_1996_2015_to10_round7_labelable.csv"
BOOKS = batch.DATA / "books_topn5_1996_2015_to10_round7.csv"
QUOTES = batch.DATA / "quotes_topn5_1996_2015_to10_round7.csv"
...
def build_selection() -> None:
    ...
    print(f"prepared {len(rows)} quote-bearing round-seven jobs")


batch.SAMPLE = SELECTION
batch.BOOK_SOURCES = (BOOKS,)
batch.QUOTE_SOURCES = (QUOTES,)
batch.CLASSIFIED = batch.DATA / "classified_topn5_1996_2015_to10_round7"
batch.RUN_ID = "20260815_terra_early_round7_v1"
