#!/usr/bin/env python3
"""Stage or promote completed quote-bearing books from the final historical refill."""
...
SELECTION = batch.DATA / "sample_top3_1931_1995_zero_label_final_labelable.csv"
...
def build_selection() -> None:
    ...
    print(f"prepared {len(rows)} completed historical refill jobs")
...
batch.CLASSIFIED = batch.DATA / "classified_top3_1931_1995_zero_label_final"
batch.RUN_ID = "20260814_terra_history_top3_zero_label_final_v1"
