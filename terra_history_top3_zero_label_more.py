#!/usr/bin/env python3
"""Stage or promote quote-bearing historical books from the zero-label refill."""
...
SOURCE_SAMPLE = batch.DATA / "sample_top3_1931_1995_zero_label_more.csv"
SELECTION = batch.DATA / "sample_top3_1931_1995_zero_label_more_labelable.csv"
BOOKS = batch.DATA / "books_top3_1931_1995_zero_label_more.csv"
QUOTES = batch.DATA / "quotes_top3_1931_1995_zero_label_more.csv"
...
def build_selection() -> None:
    ...
    print(f"prepared {len(rows)} historical refill jobs")
...
batch.CLASSIFIED = batch.DATA / "classified_top3_1931_1995_zero_label_more"
batch.RUN_ID = "20260814_terra_history_top3_zero_label_more_v1"
