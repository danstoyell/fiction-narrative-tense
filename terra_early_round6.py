#!/usr/bin/env python3
"""Stage or promote quote-bearing books from the 1996--2015 round-six fetch."""
...
SOURCE_SAMPLE = batch.DATA / "sample_topn5_1996_2015_to10_round6.csv"
SELECTION = batch.DATA / "sample_topn5_1996_2015_to10_round6_labelable.csv"
BOOKS = batch.DATA / "books_topn5_1996_2015_to10_round6.csv"
QUOTES = batch.DATA / "quotes_topn5_1996_2015_to10_round6.csv"
...
def build_selection() -> None:
    ...
    print(f"prepared {len(rows)} quote-bearing round-six jobs")


batch.SAMPLE = SELECTION
batch.BOOK_SOURCES = (BOOKS,)
batch.QUOTE_SOURCES = (QUOTES,)
batch.CLASSIFIED = batch.DATA / "classified_topn5_1996_2015_to10_round6"
batch.RUN_ID = "20260814_terra_early_round6_v1"
